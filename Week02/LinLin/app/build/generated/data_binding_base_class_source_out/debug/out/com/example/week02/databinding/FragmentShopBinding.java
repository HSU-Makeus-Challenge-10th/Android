...
public final class FragmentShopBinding implements ViewBinding {
  ...
  private FragmentShopBinding(@NonNull ConstraintLayout rootView, @NonNull TabLayout tabLayout) {
  ...
  public static FragmentShopBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentShopBinding((ConstraintLayout) rootView, tabLayout);
    }
