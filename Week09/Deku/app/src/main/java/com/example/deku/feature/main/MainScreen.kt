// 앱의 최상위 Compose 화면으로, Scaffold/BottomBar/Navigation과 공유 상품 상태를 묶습니다.
...
fun MainScreen(homeTitle: String) {
    ...
    // 현재 route를 관찰해 BottomBar의 선택 상태와 화면 전환 상태를 맞춥니다.
    ...
    fun toggleWish(productId: Int) {
        // ProductItem이 immutable data class라 copy로 새 리스트를 만들어 Compose 재구성을 유도합니다.
