...
import com.example.week02.core.network.RetrofitProvider
import com.example.week02.profile.data.repository.ProfileRepository
import kotlinx.coroutines.launch

class ProfileViewModel(application: Application) : AndroidViewModel(application) {

    private val repository = ProfileRepository(RetrofitProvider.profileService)
